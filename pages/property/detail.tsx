							...
							<Stack className={'info'}>
								<Stack className={'left-box'}>
									<Typography className={'title-main'}>
										{property?.propertyTitle}, {property?.propertyCarBody}
									</Typography>
										...
										<Stack className={'buy-rent-box'}>
											{property?.propertyYear && (
												<>
													...
													<Typography className={'buy-rent'}>{property?.propertyYear} year</Typography>
												</>
											)}
										</Stack>
										<Stack className={'divider'}></Stack>
								...
								<Stack className={'options-config'}>
									...
									<Stack className={'option'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{property?.propertyMile} km</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
