// libs/components/admin/cs/InquiryList.tsx
...
export const InquiryList: React.FC<Props> = ({ onEdit }) => {
		...
		<Box>
			<Stack direction="row" spacing={2} sx={{ mb: 2 }}>
				...
				<OutlinedInput
					size="small"
					value={text}
					placeholder="Search inquiry title or content"
				...
				<Table size="small">
					<TableHead>
						<TableRow>
							...
							<TableCell>Writer (memberId)</TableCell>
					...
					<TableBody>
						...
						{!loading && !error && rows.length === 0 && (
							<TableRow>
								<TableCell colSpan={8}>No inquiries.</TableCell>
							</TableRow>
						)}
